...
@section('content')
    <main class="main" id="top">
      ...
      <div class="content">
        <h2 class="mb-4 text-body-emphasis">Product</h2>
        <div class="row">
              ...
              <div class="card todo-list h-100">
                <div class="card-header border-bottom-0 pb-0">
                  <div class="row justify-content-between align-items-center mb-4">
                    <div class="col-auto">
                      <p class="text-body-emphasis"><b>Manage Product</b></p>
                    </div>
                    <div class="col-md-auto col-sm-12 d-flex mb-3">
                      
                      <button class="btn btn-outline-success me-1 mb-1 ms-md-auto ms-sm-0 mt-1" type="button" data-bs-toggle="modal" data-bs-target="#verticallyCentered"><i class="fa fa-plus"></i> Create Product</button>
