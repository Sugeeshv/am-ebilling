...
@canany(['route-view', 'route-create', 'route-edit', 'route-delete','user-list', 'user-edit','user-delete','user-create','product-list'])
<!-- ================= VERTICAL NAVBAR ================= -->
  ...
  <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
    <div class="navbar-vertical-content">
      <ul class="navbar-nav flex-column" id="navbarVerticalNav">
          ...
          <div class="nav-item-wrapper">
            <a class="nav-link dropdown-indicator label-1 "
              ...
              <div class="d-flex align-items-center">
                ...
                <span class="nav-link-text ms-2">Admin Management</span>
              </div>
            </a>
        ...
        @canany(['product-list'])
        <li class="nav-item">
          <div class="nav-item-wrapper"><a class="nav-link label-1" href="{{ route('product.view') }}" role="button" >
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="text-body fs-7 fab fa-opencart"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Manage Product</span></span></div>
                  </a></div>
        </li>
        <li class="nav-item">
          <hr>
        ...
        @endcanany
         @canany(['route-view', 'route-create', 'route-edit', 'route-delete'])
        <li class="nav-item">
          <div class="nav-item-wrapper"><a class="nav-link label-1" href="{{ route('route.view') }}" role="button" >
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="text-body fs-7 far fa-share-square"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Manage Route</span></span></div>
                  </a></div>
        </li>
        <li class="nav-item">
          <hr>
        ...
        @canany(['stock-view'])
        <li class="nav-item">
          <div class="nav-item-wrapper"><a class="nav-link label-1" href="{{ route('stock') }}" role="button" >
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="text-body fs-7 far fa-folder-open"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Get Stock</span></span></div>
                  </a></div>
        </li>
        <li class="nav-item">
          <hr>
        ...
        <!-- <li class="nav-item">
          <div class="nav-item-wrapper"><a class="nav-link label-1" href="" role="button" data-bs-toggle="" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="text-body fs-7 uil uil-shop"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Manage outlet</span></span></div>
                  </a></div>
        </li>
        <li class="nav-item">
          <p class="navbar-vertical-label"><hr></p>
