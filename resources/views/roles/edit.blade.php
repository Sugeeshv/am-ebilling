                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    @foreach($permission as $value)
                                        <label class="form-check-label"><input type="checkbox" name="permission[{{$value->id}}]" value="{{$value->id}}" class="form-check-input" {{ in_array($value->id, $rolePermissions) ? 'checked' : ''}}>
                                        {{ $value->name }}</label>
                                    <br/>
                                    @endforeach
                                </div>
